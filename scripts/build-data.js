...
const zastavenia = readFolder(path.join(CONTENT, "zastavenia"))
  ...
  .map(({ hlavnaKategoria, projekt, ...z }) => {
    // "hlavnaKategoria"/"projekt" sú len pomocné polia na zoskupovanie
    // v Decap CMS (/admin), do data.js sa nedávajú – app.js ich nepozná/nepotrebuje.
